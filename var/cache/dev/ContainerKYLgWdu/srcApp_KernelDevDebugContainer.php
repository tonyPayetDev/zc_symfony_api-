...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('YrDiyZRWm6', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hRwdtLnXOx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getCache_SystemClearerService()
    {
        ...
        return $this->services['cache.system_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.system' => ($this->services['cache.system'] ?? $this->getCache_SystemService()), 'cache.annotations' => ($this->privates['cache.annotations'] ?? $this->getCache_AnnotationsService()), 'api_platform.cache.route_name_resolver' => ($this->privates['api_platform.cache.route_name_resolver'] ?? $this->getApiPlatform_Cache_RouteNameResolverService()), 'api_platform.cache.identifiers_extractor' => ($this->privates['api_platform.cache.identifiers_extractor'] ?? $this->getApiPlatform_Cache_IdentifiersExtractorService()), 'api_platform.cache.subresource_operation_factory' => ($this->privates['api_platform.cache.subresource_operation_factory'] ?? $this->getApiPlatform_Cache_SubresourceOperationFactoryService()), 'api_platform.cache.metadata.resource' => ($this->privates['api_platform.cache.metadata.resource'] ?? $this->getApiPlatform_Cache_Metadata_ResourceService()), 'api_platform.cache.metadata.property' => ($this->privates['api_platform.cache.metadata.property'] ?? $this->getApiPlatform_Cache_Metadata_PropertyService())]);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_pgsql', 'url' => $this->getEnv('resolve:DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => '12', 'defaultTableOptions' => []], $a, $b, []);
    }
    ...
    protected function getServicesResetterService()
    {
        ...
        }), ['cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'debug.event_dispatcher' => [0 => 'reset'], 'doctrine' => [0 => 'reset'], 'api_platform.cache.route_name_resolver' => [0 => 'reset'], 'api_platform.cache.identifiers_extractor' => [0 => 'reset'], 'api_platform.cache.subresource_operation_factory' => [0 => 'reset'], 'api_platform.cache.metadata.resource' => [0 => 'reset'], 'api_platform.cache.metadata.property' => [0 => 'reset']]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uHCxy9ycxo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q8C0QWFsZN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wfwq3Hi3NX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SeqfAjl9um', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hGUS-RPGjT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7xqVkpi73z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder0b099 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd741d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesca5e8 = [
        
    ];

    public function getConnection()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getConnection', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getMetadataFactory', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getExpressionBuilder', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'beginTransaction', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getCache', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'transactional', array('func' => $func), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->transactional($func);
    }

    public function commit()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'commit', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->commit();
    }

    public function rollback()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'rollback', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getClassMetadata', array('className' => $className), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'createQuery', array('dql' => $dql), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'createNamedQuery', array('name' => $name), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'createQueryBuilder', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'flush', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'clear', array('entityName' => $entityName), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->clear($entityName);
    }

    public function close()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'close', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->close();
    }

    public function persist($entity)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'persist', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'remove', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'refresh', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'detach', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'merge', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'contains', array('entity' => $entity), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getEventManager', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getConfiguration', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'isOpen', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getUnitOfWork', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getProxyFactory', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'initializeObject', array('obj' => $obj), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'getFilters', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'isFiltersStateClean', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'hasFilters', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return $this->valueHolder0b099->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd741d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder0b099) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder0b099 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder0b099->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, '__get', ['name' => $name], $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        if (isset(self::$publicPropertiesca5e8[$name])) {
            return $this->valueHolder0b099->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder0b099;
    ...
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;
    ...
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, '__isset', array('name' => $name), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;
    ...
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, '__unset', array('name' => $name), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;
    ...
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, '__clone', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        $this->valueHolder0b099 = clone $this->valueHolder0b099;
    }

    public function __sleep()
    {
        $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, '__sleep', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;

        return array('valueHolder0b099');
    }
    ...
    {
        $this->initializerd741d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd741d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd741d && ($this->initializerd741d->__invoke($valueHolder0b099, $this, 'initializeProxy', array(), $this->initializerd741d) || 1) && $this->valueHolder0b099 = $valueHolder0b099;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder0b099;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder0b099;
    }
